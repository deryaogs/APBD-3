...
public class DeviceManagerTests
{
    ...
    {
        // Creating the DeviceManager instance using the Factory
        _deviceManager = DeviceManagerFactory.CreateDeviceManager();
        
        // Adding initial devices to the device manager
